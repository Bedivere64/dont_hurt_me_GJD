...
用法: python etf_trend.py [ETF代码] [天数]
示例: python etf_trend.py 512070 500
"""
...
if __name__ == '__main__':
    ...
    if trend:
        output_path = os.path.join(PROJECT_DIR, f'etf_{etf_code}_trend.html')
